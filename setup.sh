...
|  \| | ' / | |  _ / _` | '_ ` _ \ / _ \ '__|
| |\  | . \ | |_| | (_| | | | | | |  __/ |
|_| \_|_|\_(_)____|\__,_|_| |_| |_|\___|_          
 ...
 Version: \033[1;92m2.1
   \033[0m"
   echo
	printf "\e[1;34m\tSelect your terminal to install osint \e[0m\n"
...
echo
cp -r osint $PREFIX/bin
cp -r subdomains.txt $PREFIX/bin
cd $PREFIX/bin && chmod u+x osint
cd $PREFIX/bin && chmod u+x subdomains.txt
cd $HOME
rm -rf osint
printf "\e[1;91m[*]\e[1;97m osint Installed Successfully, Now its ready for use. So re-open your Termux To use osint\e[0m\n" 
printf "\e[1;91m[*]\e[1;97m After reopen your termux just type '\e[1;91mosint\e[1;97m' to launch osint \e[0m" 
exit
...
sleep 1
echo
sudo cp -r osint /usr/local/bin
cd /usr/local/bin && sudo chmod u+x osint
cd $HOME && sudo rm -rf osint
 printf "\e[1;91m[*]\e[1;97m osint Installed Successfully, Now its ready for use. So re-open your Linux Terminal To use osint\e[0m\n"
 echo
 echo
 printf "\e[1;91m[*]\e[1;97m After reopen your terminal just type '\e[1;91msudo osint\e[1;97m' to launch osint \e[0m" 
 echo ""
 exit
else 
